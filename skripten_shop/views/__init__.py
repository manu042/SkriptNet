from .ausgabe_views import scan_legic_view, ausgabe_view, individual_assistance_view, reorder_view, aktivierungs_view, \
    reaktivierungs_view, newlegic_view
...
__all__ = ['scan_legic_view', 'ausgabe_view', 'individual_assistance_view', 'reorder_view', 'aktivierungs_view',
           'reaktivierungs_view', 'newlegic_view', 'login_view', 'logout_view', 'registration_view',
           'confirm_mail_view',
